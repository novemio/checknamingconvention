...
object HtmlPrefixesTab: BaseHtmlPage() {


    fun createPage(pageName:String,errorMap: HashMap<String, List<NamingCheckResult>>): String {
        val page = """


<div id="$pageName" class="tabcontent">
